...
Let me introduce myself, I'm **Ralph Angelo Jaminal**. On this occasion, I'd like to share the portfolio website project that I've developed.
...
```bash
git clone https://github.com/severusraj/severusraj-portfolio.git
cd PF
```
...
VALUES ('Created By Ralph Angelo Jaminal', 'severusraj');
